 ...
 * @author Amir
 */
public class AppTest4 extends Applet {
	...
	public void addChildren() {
		...
		TrunkShape ts=new TrunkShape(new Trunk(16,0,0f,2f,new Random(39325),12f,0.3f,0.5f),ap,0.01f,0.2f,5);
		ts.addChildren(10,0.5f,0.2f,1.7f,0.3f,0.7f,7,-0.3f,0.3f,0.1f,0.4f,0.5f,TreeShape.CYLINDRICAL,ap);
		tg.addChild(ts);
